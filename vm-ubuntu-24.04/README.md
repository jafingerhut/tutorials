...
As of 2024-07-01, the p4c compiler passes all but about 15 of its
...
```
Open source P4 development tools built from latest source code as of 2024-Jul-01 and packaged into an Ubuntu 24.04 Desktop Linux VM for the AMD64 architecture.
```
