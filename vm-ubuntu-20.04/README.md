...
As of 2022-12-01, the p4c compiler passes all but 69 of its included
tests.
...
+ 'P4 Tutorial Development 2022-12-03'
...
+ Select the VM named 'P4 Tutorial Development 2022-12-03' and click
  Continue button
...
+ Target file
  + I used: /Users/andy/Documents/P4 Tutorials Development 2022-12-03.ova
+ Mac Address Policy
...
+ Name: P4 Tutorial Development 2022-12-03
...
```
Open source P4 development tools built from latest source code as of 2022-Dec-03 and packaged into an Ubuntu 20.04 Desktop Linux VM for the AMD64 architecture.
```
