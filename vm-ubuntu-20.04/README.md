...
As of 2023-09-01, the p4c compiler passes all of its included tests,
...
+ 'P4 Tutorial Development 2023-09-01'
...
+ Select the VM named 'P4 Tutorial Development 2023-09-01' and click
  Continue button
...
+ Target file
  + I used: /Users/andy/Documents/P4 Tutorials Development 2023-09-01.ova
+ Mac Address Policy
...
```
Open source P4 development tools built from latest source code as of 2023-Sep-01 and packaged into an Ubuntu 20.04 Desktop Linux VM for the AMD64 architecture.
```
